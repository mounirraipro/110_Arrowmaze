...
export const metadata: Metadata = {
    ...
    description: 'Arrow Maze is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Arrow Maze accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Arrow Maze accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Arrow Maze is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Arrow Maze presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Arrow Maze. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@arrowmaze.org</strong></li>
                </ul>
                <p>
