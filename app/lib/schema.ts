...
const SITE_URL = 'https://arrowmaze.org';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Arrow Maze',
        url: SITE_URL,
        description: 'Play Arrow Maze free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Arrow Maze online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
