...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Arrow Maze puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Arrow Maze categories'],
  alternates: {
