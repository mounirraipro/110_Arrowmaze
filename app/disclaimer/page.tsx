...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Arrow Maze disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Arrow Maze disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Arrow Maze (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on arrowmaze.org
                ...
                <p>
                    Arrow Maze is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Arrow Maze displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Arrow Maze.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Arrow Maze is not responsible for any errors
