...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Arrow Maze uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Arrow Maze cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Arrow Maze uses them, and how you can
                ...
                <p>Arrow Maze uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Arrow Maze.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@arrowmaze.org</strong>.
                </p>
            </div>
        </>
    );
