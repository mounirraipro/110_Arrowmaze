...
const SUPPORT_EMAIL = 'hello@arrowmaze.org';

export const metadata: Metadata = {
    title: 'Contact Arrow Maze',
    description: 'Get in touch with the Arrow Maze team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Arrow Maze', 'Arrow Maze support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
