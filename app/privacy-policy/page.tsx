...
export const metadata: Metadata = {
    ...
    description: 'Read the Arrow Maze Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Arrow Maze privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Arrow Maze, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Arrow Maze, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Arrow Maze is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@arrowmaze.org</strong>.
                </p>
            </div>
        </>
    );
