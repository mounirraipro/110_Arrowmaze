...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Arrow Maze. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Arrow Maze sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Arrow Maze' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Arrow Maze?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Arrow Maze.</p>
                </div>
            </div>
